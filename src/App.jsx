  ...
  return (
    <div className="app-shell">
      ...
      <main className="store-main">
        ...
        <section id="home" className="hero">
          <div className="container hero-container">
            <div className="hero-content">
              ...
              <p>Premium fans, coolers, AC, appliances & electrical products from trusted brands</p>
            ...
            <div className="hero-collage">
              <div className="collage-grid">
                <img src="/hero.png" alt="Appliances" className="collage-item collage-featured" />
                <div className="collage-item-small collage-item-1">
                  <svg viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <rect x="10" y="30" width="80" height="50" rx="4" fill="white" stroke="currentColor" strokeWidth="2"/>
                    <rect x="15" y="35" width="70" height="35" fill="currentColor" opacity="0.2"/>
                  </svg>
                  <p>Fans</p>
                </div>
                <div className="collage-item-small collage-item-2">
                  <svg viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <rect x="20" y="20" width="60" height="60" rx="8" fill="white" stroke="currentColor" strokeWidth="2"/>
                    <rect x="30" y="30" width="40" height="40" fill="currentColor" opacity="0.2"/>
                  </svg>
                  <p>AC</p>
                </div>
                <div className="collage-item-small collage-item-3">
                  <svg viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M50 10 L70 40 L55 40 L55 80 L45 80 L45 40 L30 40 Z" fill="white" stroke="currentColor" strokeWidth="2"/>
                  </svg>
                  <p>Coolers</p>
                </div>
              </div>
        ...
        <section id="categories" className="shop-by-category">
          <div className="container">
            <div className="section-header">
              <h2>Everything Your Home Needs</h2>
              <p>Browse our comprehensive collection by category</p>
            </div>
            <div className="category-showcase-grid">
              <div className="category-showcase-card">
                ...
                <ul>
                  <li>Electric Rice Cooker</li>
                  <li>Induction Stove</li>
                  <li>Kitchen Appliances</li>
                </ul>
                <button className="category-showcase-btn" onClick={() => { 
